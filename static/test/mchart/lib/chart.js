...
Time_series_chart.prototype.draw_stackChart = function(data, param) {
  this.VIZ.stackChart(data, param);
}

Time_series_chart.prototype.draw_lineChart = function(data) {
  this.VIZ.lineChart(data);
}

Time_series_chart.prototype.draw_stackBarChart = function(data) {
    this.VIZ.stackBarChart($.extend(true, [], data));
}